            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header bg-primary text-white">
                        ...
                        Payments Table
                        <a href="{{route('payment.index')}}" class="text-white offset-10" style="height:20px;">
                                            ...
                                            <div class="wrapper">
                                                ...
                                                <div class="content">
                                                    <div id="cash" class="data">
                                                        <form action="{{route('payment.store')}}" id="cash-method-form" method="post">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">Adjust Advance</label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" id="adjust_advance" name="adjust_advance" placeholder="Adjust Advance" class=" @error('adjust_advance') is-invalid @enderror">
                                                                    @error('adjust_advance')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                                    @enderror
                                                    ...
                                                    <div id="bank" class="data">
                                                        <form action="{{route('payment.store')}}" id="bank-method-form" method="post">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <input type="text" id="bank_code_id" name="bank_code_id" placeholder="Enter Bank Id" class="@error('bank_code_id') is-invalid @enderror">
                                                                    @error('bank_code_id')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                    ...
                                                    <div id="bkash" class="data">
                                                        <form action="{{route('payment.store')}}" id="bkash-method-form" method="post">
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">From bKash No:</label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" id="from_bKash" name="from_bKash" placeholder="Enter the number" class="@error('from_bKash') is-invalid @enderror">
                                                                    @error('from_bKash')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-sm-3 col-form-label">To bKash No:</label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" id="to_bKash" name="to_bKash" placeholder="Enter the number" class=" @error('to_bKash') is-invalid @enderror">
                                                                    @error('to_bKash')
                                                                    <span class="invalid-feedback" role="alert">
                                                                        <strong>{{ $message }}</strong>
                                                                    </span>
