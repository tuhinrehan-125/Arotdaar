@extends('layouts.main', ['activePage' => 'collection', 'titlePage' => __('Payment')])
            ...
            <div class="container-fluid">
                ...
                <div class="card mb-3">
                    <div class="card-header bg-primary text-white">
                        ...
                        Collection Table
                        <a href="{{route('collection.index')}}" class="text-white offset-10" style="height:20px;">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="text-center" style="height: 50px; ">
                                            <h4 class=" card-title">Collection Form</h4>
                                        </div>
                                        <div class="search">
                                            <form action="">
                                            ...
                                            <div class="wrapper">
                                                ...
                                                <div class="content">
                                                    <div id="cash" class="data">
                                                        <form action="{{route('collection.store')}}" id="cash-method-form" method="post">

                                                            @csrf
                                                            <input type="hidden" id="advance-id" name="cashId" value="">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-9">
                                                                    <select name="customer_id" id="customerId" class="clientId">
                                                    ...
                                                    <div id="bank" class="data">
                                                        <form action="{{route('collection.store')}}" id="bank-method-form" method="post">

                                                            @csrf
                                                            <input type="hidden" id="collection-id" name="bankId" value="">
                                                    ...
                                                    <div id="bkash" class="data">
                                                        <form action="{{route('collection.store')}}" id="bkash-method-form" method="post">

                                                            @csrf
                                                            <input type="hidden" id="collection-id" name="bkashId" value="">
