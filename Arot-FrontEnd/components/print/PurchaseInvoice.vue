      ...
      <div class="card-body">
        <div class="row mb-4">
          <div class="col-sm-6">
            ...
            <img width="100px" height="100px" :src="arot.arot_image" alt="arotimage">
            <div>{{arot.arot_name}}</div>
            <div>{{arot.arot_address}}</div>
            <div>Phone: {{arot.arot_phone}}</div>
          </div>
          ...
          <div class="col-lg-4 col-sm-5 ml-auto">
            <table class="table table-clear">
              <tbody>
                ...
                <tr>
                  <td class="left">
                    <strong>Commission ({{ commission }})% :</strong>
                  </td>
