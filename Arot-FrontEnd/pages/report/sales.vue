<template>
  <v-container>
    <v-row>
      <v-col>
        <p class="text-center font-weight-bold">Sales Report</p>
      </v-col>
    </v-row>
    <v-row>
          ...
          <v-card-text>
            <v-row>
              ...
              <v-col cols="12" sm="5" md="3">
                <v-btn dark elevation="2" medium color="indigo" @click="salesReport"
                  >Sumit</v-btn
                >
              </v-col>
            </v-row>
    ...
    <v-row>
      <v-col cols="12" sm="12" md="12">
        <v-card>
          <v-card-title>{{ $t("sales_report") }}</v-card-title>
          <v-card-text>
            <v-skeleton-loader
              class="mx-auto"
              type="table"
